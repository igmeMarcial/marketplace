...
var API_KEY = 're_QBcqJWTL_CvWoxie1kQZd1QfRmn9sixJo';
var resend = new resend_1.Resend(API_KEY);
//función que maneja las solicitudes de webhook de Stripe
var stripeWebhookHandler = function (req, // La solicitud HTTP entrante de Express
res // La respuesta HTTP de Express
        ...
        switch (_c.label) {
            ...
            case 5:
                ...
                return [4 /*yield*/, resend.emails.send({
                        ...
                        to: [user.email],
                        subject: '¡Gracias por tu orden! Este es tu recibo.',
